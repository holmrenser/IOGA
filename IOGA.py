...
def IOGA_loop(name,ref,forward,reverse,insertsize,threads):
	"""
...
def main(ref,name,forward,reverse,threads,insertsize):
	"""
	IOGA
	"""
	iteration = 0
	...
	out,FP,RP,final_iteration = IOGA_loop(name,ref,forward,reverse,insertsize,threads)
...
if __name__ == '__main__':
	...
	main(args.reference,args.name,args.forward,args.reverse,args.threads,args.insertsize)
